...
prep:
	...
	@[ ! -f $(CONFIG)/inc/bit.h ] && cp projects/esp-freebsd-default-bit.h $(CONFIG)/inc/bit.h ; true
	@if ! diff $(CONFIG)/inc/bit.h projects/esp-freebsd-default-bit.h >/dev/null ; then\
		cp projects/esp-freebsd-default-bit.h $(CONFIG)/inc/bit.h  ; \
	fi; true
...
$(CONFIG)/bin/libappweb.so: $(DEPS_15)
	...
	$(CC) -shared -o $(CONFIG)/bin/libappweb.so $(LIBPATHS) "$(CONFIG)/obj/appwebLib.o" $(LIBPATHS_15) $(LIBS_15) $(LIBS_15) $(LIBS) 
endif
...
$(CONFIG)/bin/appweb: $(DEPS_18)
	...
	$(CC) -o $(CONFIG)/bin/appweb $(LIBPATHS) "$(CONFIG)/obj/appweb.o" $(LIBPATHS_18) $(LIBS_18) $(LIBS_18) $(LIBS) $(LIBS) 
endif
...
$(CONFIG)/bin/libejs.so: $(DEPS_26)
	...
	$(CC) -shared -o $(CONFIG)/bin/libejs.so $(LIBPATHS) "$(CONFIG)/obj/ejsLib.o" $(LIBPATHS_26) $(LIBS_26) $(LIBS_26) $(LIBS) 
endif
...
$(CONFIG)/bin/ejsc: $(DEPS_28)
	...
	$(CC) -o $(CONFIG)/bin/ejsc $(LIBPATHS) "$(CONFIG)/obj/ejsc.o" $(LIBPATHS_28) $(LIBS_28) $(LIBS_28) $(LIBS) $(LIBS) 
endif
...
$(CONFIG)/bin/http: $(DEPS_35)
	...
	$(CC) -o $(CONFIG)/bin/http $(LIBPATHS) "$(CONFIG)/obj/http.o" $(LIBPATHS_35) $(LIBS_35) $(LIBS_35) $(LIBS) $(LIBS) 
...
$(CONFIG)/bin/libmprssl.so: $(DEPS_37)
	...
	$(CC) -shared -o $(CONFIG)/bin/libmprssl.so $(LIBPATHS) "$(CONFIG)/obj/mprSsl.o" $(LIBPATHS_37) $(LIBS_37) $(LIBS_37) $(LIBS) 
...
$(CONFIG)/bin/sqlite: $(DEPS_42)
	...
	$(CC) -o $(CONFIG)/bin/sqlite $(LIBPATHS) "$(CONFIG)/obj/sqlite.o" $(LIBPATHS_42) $(LIBS_42) $(LIBS_42) $(LIBS) $(LIBS) 
endif
