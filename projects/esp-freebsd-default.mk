...
$(CONFIG)/bin/libhttp.so: $(DEPS_14)
	...
	$(CC) -shared -o $(CONFIG)/bin/libhttp.so $(LIBPATHS) "$(CONFIG)/obj/httpLib.o" $(LIBPATHS_14) $(LIBS_14) $(LIBS_14) $(LIBS) 
endif
...
$(CONFIG)/bin/libappweb.so: $(DEPS_17)
	...
	$(CC) -shared -o $(CONFIG)/bin/libappweb.so $(LIBPATHS) "$(CONFIG)/obj/appwebLib.o" $(LIBPATHS_17) $(LIBS_17) $(LIBS_17) $(LIBS) 
endif
...
$(CONFIG)/bin/libmod_esp.so: $(DEPS_30)
	...
	$(CC) -shared -o $(CONFIG)/bin/libmod_esp.so $(LIBPATHS) "$(CONFIG)/obj/edi.o" "$(CONFIG)/obj/espAbbrev.o" "$(CONFIG)/obj/espDeprecated.o" "$(CONFIG)/obj/espFramework.o" "$(CONFIG)/obj/espHandler.o" "$(CONFIG)/obj/espHtml.o" "$(CONFIG)/obj/espTemplate.o" "$(CONFIG)/obj/mdb.o" "$(CONFIG)/obj/sdb.o" $(LIBPATHS_30) $(LIBS_30) $(LIBS_30) $(LIBS) 
...
$(CONFIG)/bin/esp: $(DEPS_32)
	...
	$(CC) -o $(CONFIG)/bin/esp $(LIBPATHS) "$(CONFIG)/obj/edi.o" "$(CONFIG)/obj/esp.o" "$(CONFIG)/obj/espAbbrev.o" "$(CONFIG)/obj/espDeprecated.o" "$(CONFIG)/obj/espFramework.o" "$(CONFIG)/obj/espHandler.o" "$(CONFIG)/obj/espHtml.o" "$(CONFIG)/obj/espTemplate.o" "$(CONFIG)/obj/mdb.o" "$(CONFIG)/obj/sdb.o" $(LIBPATHS_32) $(LIBS_32) $(LIBS_32) $(LIBS) $(LIBS) 
...
$(CONFIG)/bin/libmprssl.so: $(DEPS_39)
	...
	$(CC) -shared -o $(CONFIG)/bin/libmprssl.so $(LIBPATHS)   "$(CONFIG)/obj/mprSsl.o" $(LIBPATHS_39) $(LIBS_39) $(LIBS_39) $(LIBS) 
