...
$(CONFIG)/bin/libhttp.dylib: $(DEPS_11)
	...
	$(CC) -dynamiclib -o $(CONFIG)/bin/libhttp.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) -install_name @rpath/libhttp.dylib -compatibility_version 5.0 -current_version 5.0 "$(CONFIG)/obj/httpLib.o" $(LIBPATHS_11) $(LIBS_11) $(LIBS_11) $(LIBS) 
endif
...
ifeq ($(ME_COM_HTTP),1)
    DEPS_14 += $(CONFIG)/bin/libhttp.dylib
endif
...
$(CONFIG)/bin/libappweb.dylib: $(DEPS_14)
	...
	$(CC) -dynamiclib -o $(CONFIG)/bin/libappweb.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) -install_name @rpath/libappweb.dylib -compatibility_version 5.0 -current_version 5.0 "$(CONFIG)/obj/appwebLib.o" $(LIBPATHS_14) $(LIBS_14) $(LIBS_14) $(LIBS) 
endif
...
$(CONFIG)/obj/authpass.o: \
	...
	$(CC) -c $(DFLAGS) -o $(CONFIG)/obj/authpass.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) src/paks/appweb/authpass.c
...
ifeq ($(ME_COM_APPWEB),1)
    DEPS_16 += $(CONFIG)/bin/libappweb.dylib
endif
...
$(CONFIG)/bin/authpass: $(DEPS_16)
	...
	$(CC) -o $(CONFIG)/bin/authpass -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/authpass.o" $(LIBPATHS_16) $(LIBS_16) $(LIBS_16) $(LIBS) 
...
ifeq ($(ME_COM_APPWEB),1)
    DEPS_35 += $(CONFIG)/bin/libappweb.dylib
endif
DEPS_35 += $(CONFIG)/inc/sqlite3.h
DEPS_35 += $(CONFIG)/obj/sqlite3.o
ifeq ($(ME_COM_SQLITE),1)
    DEPS_35 += $(CONFIG)/bin/libsql.dylib
endif
...
$(CONFIG)/bin/libmod_esp.dylib: $(DEPS_35)
	@echo '      [Link] $(CONFIG)/bin/libmod_esp.dylib'
	$(CC) -dynamiclib -o $(CONFIG)/bin/libmod_esp.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) -install_name @rpath/libmod_esp.dylib -compatibility_version 5.0 -current_version 5.0 "$(CONFIG)/obj/edi.o" "$(CONFIG)/obj/espAbbrev.o" "$(CONFIG)/obj/espConfig.o" "$(CONFIG)/obj/espFramework.o" "$(CONFIG)/obj/espHandler.o" "$(CONFIG)/obj/espHtml.o" "$(CONFIG)/obj/espTemplate.o" "$(CONFIG)/obj/mdb.o" "$(CONFIG)/obj/sdb.o" $(LIBPATHS_35) $(LIBS_35) $(LIBS_35) $(LIBS) 
...
ifeq ($(ME_COM_APPWEB),1)
    DEPS_37 += $(CONFIG)/bin/libappweb.dylib
endif
DEPS_37 += $(CONFIG)/inc/sqlite3.h
DEPS_37 += $(CONFIG)/obj/sqlite3.o
ifeq ($(ME_COM_SQLITE),1)
    DEPS_37 += $(CONFIG)/bin/libsql.dylib
endif
...
DEPS_37 += $(CONFIG)/bin/libmod_esp.dylib
...
$(CONFIG)/bin/esp: $(DEPS_37)
	...
	$(CC) -o $(CONFIG)/bin/esp -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/esp.o" $(LIBPATHS_37) $(LIBS_37) $(LIBS_37) $(LIBS) 
...
$(CONFIG)/bin/libest.dylib: $(DEPS_41)
...
$(CONFIG)/bin/libmprssl.dylib: $(DEPS_43)
	@echo '      [Link] $(CONFIG)/bin/libmprssl.dylib'
	$(CC) -dynamiclib -o $(CONFIG)/bin/libmprssl.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS)    -install_name @rpath/libmprssl.dylib -compatibility_version 5.0 -current_version 5.0 "$(CONFIG)/obj/mprSsl.o" $(LIBPATHS_43) $(LIBS_43) $(LIBS_43) $(LIBS) 
...
$(CONFIG)/bin/espman: $(DEPS_45)
	...
	$(CC) -o $(CONFIG)/bin/espman -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/manager.o" $(LIBPATHS_45) $(LIBS_45) $(LIBS_45) $(LIBS) 
...
DEPS_47 += $(CONFIG)/bin/libsql.dylib
...
$(CONFIG)/bin/sqlite: $(DEPS_47)
	...
	$(CC) -o $(CONFIG)/bin/sqlite -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/sqlite.o" $(LIBPATHS_47) $(LIBS_47) $(LIBS_47) $(LIBS) 
endif
