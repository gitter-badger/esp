...
build/$(CONFIG)/bin/libmpr.out: $(DEPS_10)
...
build/$(CONFIG)/bin/libpcre.out: $(DEPS_13)
...
build/$(CONFIG)/bin/libhttp.out: $(DEPS_16)
...
build/$(CONFIG)/bin/libsql.out: $(DEPS_22)
